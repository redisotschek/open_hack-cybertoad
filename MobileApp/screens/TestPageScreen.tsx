...
import { MeterValue } from '../constants/Forms';
...
export default function TestPageScreen() {
  ...
  const results = () => {
    if (!!resultsArray) {
      let results = resultsArray.map((result: MeterValue, i: number) => {
  ...
  return (
    ...
    >
      ...
      { isLoading && (<Image
        ...
        style={ {width: 256, height: 256, marginBottom: -40} }
      />) }
      <TouchableHighlight
