...
import { StyleSheet, Text, View, TouchableOpacity, Image, ImageBackground, DeviceEventEmitter } from 'react-native';
...
export default function App() {
  ...
  const __sendPhoto = async () => {
    DeviceEventEmitter.emit('sendPhoto', capturedImage);
    __closeCamera();
  };
